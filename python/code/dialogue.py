...
class DialogBox:
    ...
    def __init__(self, screen, font):  #Initialise la boite de dialogue
        self.box = pygame.image.load('python/dialogue/dialog_box.png')
        self.box = pygame.transform.scale(self.box, (700, 96))  #Défini la dimension de la boite de dialogue
        self.texts = []
        self.text_index = 0
        self.letter_index = 0
        self.font = pygame.font.Font('python/dialogue/Blender-Pro-Bold.ttf', 23)    #Défini la police de la boite de dialogue
        self.reading = False
